...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Token-authenticated REST API for OpsDesk todos, products, and expenses. '
            .'Call POST /api/login with an email and password to get a bearer token, then use the '
            .'"Authorize" button above with `Bearer <token>` to try the protected endpoints below.',
    ],
